...
Figure \@ref(fig:plot1) displays Kaplan–Meier (KM) estimates of the survival curves overall and stratified by treatment group (high-dose IFN vs. observation). A clear plateau at approximately four years suggests the presence of long-term survivors, motivating the use of a cure rate model for this dataset.
