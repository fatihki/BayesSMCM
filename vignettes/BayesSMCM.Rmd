...
Two covariates, $\mathbf{Z_1}$ and $\mathbf{Z_2}$ are independently generated respectively from a Bernoulli distribution with probability $0.5$, i.e. Bernoulli$(0.5),$ and from a standard normal distribution, i.e. $\mathcal{N}(0,1)$. The covariates $\mathbf{X}$ and $\mathbf{Z}$ are assumed to be the same.
