#' Chemotherapy for Stage B/C colon cancer data from \pkg{survival} R package
#'
#' All information is retrieved from \pkg{survival}::\link[survival]{colon}.
...
#' @references
#' 
#' Therneau T (2024). A Package for Survival Analysis in R. R package version 3.8-3, 
